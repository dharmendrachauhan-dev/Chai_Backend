...
const loginUser = asyncHandler(async (req, res) => {
  ...
  // ye dusra user hai 131 line isPasswordCorrect is taken from custom method in user.models.js
  ...
  select("-password", "-refreshToken") // jo jo field nhi chahiye vo mana kar do
